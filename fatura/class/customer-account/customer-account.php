...
Class Modul {
    ...
    public $primary ="id";
    public $table_fields = array("custumer_id","name","biling_account_id","by_location","set_invoice");
    ...
    {
        global $db;
        $server_bilgileri=array(
            "database_host"=>$_POST['database_host'],
            "database_name"=>$_POST['database_name'],
            "database_user"=>$_POST['database_user'],
            "database_pass"=>$_POST['database_pass'],
        );
        $this->table_fields_extra_val[]=json_encode($server_bilgileri);
